...
--------Close-------#Bibak
		...
		local keyboard = {}
							keyboard.inline_keyboard = {
								{
                   {text = 'BG TeaM ⇜', url = 'https://t.me/victoriateam'}
				}
							}
...
-------------------
    ...
    keyboard.inline_keyboard = {
         {
				 {text = '• کانال ما', url = 'https://t.me/victoriateam'}
                },{
                   {text = '• نویسنده سورس', url = 'https://t.me/little_princeO_o'}
				   }
							}
